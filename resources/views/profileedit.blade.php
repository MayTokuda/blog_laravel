                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('profileupdate', ['id' => $user->id ] ) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <dl class="form-list">
                            ...
                            <img id="sample1" class="user-img prof-img" src="{{ asset('no_image.jpg') }}" width="75vw"><br>
                            @else
                            <img id="sample1" class="user-img prof-img" src="{{ asset('storage/' .$user->profile_image) }}" width="75vw"><br>
                            @endif
                            <!-- <img id="sample1" class="user-img prof-img" src="{{ asset('storage/' .$user->profile_image) }}" width="75vw"><br> -->
                            ...
                            <dd><input id="input1" type="file" name="profile_image" value="{{$user->profile_image}}" accept="image/png,image/jpeg"></dd>
